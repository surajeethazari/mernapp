      ...
      <Container maxWidth="xl">
        ...
        <Container component="main" maxWidth="xl">
          <Box display="flex" flexDirection={'column'} mt={5} mb={5} sx={{}}>
            ...
            >
              Information You Give Us We receive and may store any information
              you enter on our website. For example, we collect information from
              you when you place an order, create an account, call us with a
              question, create a Wish List, write a review, or use any of our
              services.
            </Typography>
            <Typography
              color={'primary.main'}
            ...
            <Typography
              ...
              sx={{ fontWeight: 'normal', marginTop: 5 }}
            >
              It may also include information you give us about other people,
              such as the name and address of a gift recipient, or the name and
              contact info of a friend & Family. Information from Other Sources
            </Typography>
            <Typography
              color={'primary.main'}
              variant="h6"
            ...
            >
              ...
              including third parties that help us update, expand and analyze
              our records and identify new customers.
            </Typography>
            <Typography
              color={'primary.dark'}
              variant="h6"
            ...
            >
              ...
              shopping experience on our websites. This cookie may facilitate
              the tailoring of advertisements and offers to you, sometimes in
            ...
            <Typography
              ...
              sx={{ fontWeight: 'normal', marginTop: 5 }}
            >
              To help us understand and enhance our interactions with visitors
              to our websites, we may permit web analytics providers to collect
            ...
            >
              ...
              device you're using or your specific location to help your
              shipping cost.
            </Typography>
            <Typography
              color={'primary.dark'}
            ...
            <Typography
              ...
              sx={{ fontWeight: 'normal', marginTop: 2 }}
            >
              EthnicPlus does not sell, rent or trade your personal information
              to third parties.
            </Typography>
            <Typography
              color={'primary.main'}
            ...
            >
              We may share your information with third parties to perform
            ...
            >
              ...
              response to a regulation, court order or subpoena. We may also
              share information when we believe it's necessary to comply with
              the law. We may also share information to respond to a government
              request or when we believe disclosure is necessary or appropriate
              to protect the rights, property or safety of EthnicPlus, our
              customers, or others; to prevent harm or loss; or in connection
              with an investigation of suspected or actual unlawful activity.
            </Typography>
            <Typography
              color={'primary.main'}
              variant="h6"
            ...
            <Typography
              ...
              sx={{ fontWeight: 'normal', marginTop: 2 }}
            >
              Whether you are shopping online or in our stores, we use
              reasonable security measures to protect the confidentiality of
              personal information under our control and appropriately limit
              access to it. EthnicPlus cannot ensure or warrant the security of
